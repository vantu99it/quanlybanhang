...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 10, 2023 lúc 10:32 AM
...
(52, 92, 1, 0, 0, 220000, '', '2023-02-22', 3, 3, 1, 3, 2, '2023-02-26 04:44:31', NULL),
...
--
ALTER TABLE `tbl_warehouse`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=876;
