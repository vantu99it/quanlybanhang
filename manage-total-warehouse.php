...
<body>
        ...
        <div id="main-right">
            <section class="main-right-title" style = "margin-bottom: 5px;">
                ...
                <section class="main-right-filter">
                    ...
                    <div class="account-btn">
                        <a href="./manage-total-warehouse.php?brand=1" class="btn btn-post btn-add <?php if(isset($_GET['brand']) && $_GET['brand'] == 1){echo "btn-active";}?>">Cơ sở 1</a>
                    </div>
                    <div class="account-btn">
    ...
    <div class="noti">
        <div class="success-checkmark">
            ...
            <a href="./manage-total-warehouse.php?brand=<?php echo $id_brand_get?>" class="btn">OK</a>
        </div>
    </div>
    <?php }?>
    <!-- Thông báo thất bại -->
